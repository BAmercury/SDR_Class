...
class sdr_T580_final_project(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'C:\\Users\\brian\\Documents\\SDR_Class\\FinalProject\\data_source.bin', False)
    ...
    def set_samp_per_symbol(self, samp_per_symbol):
        ...
        self.set_rrc_taps(firdes.root_raised_cosine(self.nfilts, self.nfilts, 1.0/float(self.samp_per_symbol), 0.35, 11*self.samp_per_symbol*self.nfilts))
